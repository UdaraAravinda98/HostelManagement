...
{
    public partial class Fourthfloor : Form
    {
        ...
        public void populateGrid()
        {
            ...
            string query = "select Assets.RoomId,StuDetails.Regno, Assets.Frontkey, Assets.Backkey, Assets.Beds, Assets.Mattress, Assets.Tables, Assets.Chairs, Assets.Fans ,Assets.Floor from Assets inner join StuDetails on  Assets.RoomId = StuDetails.Room and Assets.Floor = 'Fourth Floor' ";
        ...
        private void Fourthfloor_Load(object sender, EventArgs e)
        {
            populateGrid();
        }
